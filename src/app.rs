...
impl App {
    ...
    /// Returns the number of filtered themes without allocating
    ...
    /// Returns the number of filtered fonts without allocating
    ...
    /// Returns the number of filtered segments without allocating
